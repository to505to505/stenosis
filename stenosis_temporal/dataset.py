"""Temporal sequence dataset for stenosis detection.

Builds sliding windows of T consecutive frames from angiography sequences,
...
def get_dataloader(split: str, cfg: Config, shuffle: bool = False) -> DataLoader:
    ds = StenosisTemporalDataset(split, cfg)
    return DataLoader(
        ds,
