#!/usr/bin/env python3
"""
Create a combined dataset: ALL of ARCADE (train+val+test) as training
+ dataset2_split train/valid/test.

Training split: arcade train + arcade val + arcade test + dataset2_split train
...
COMBINED = BASE / "combined_arcade_full_dataset2"
...
def main():
    ...
    # === Copy ALL ARCADE splits into train ===
    print("=== Copying ALL ARCADE data into train ===")
    total_arcade = 0
    for arc_split in ["train", "val", "test"]:
    ...
    # === Copy dataset2_split train into train (remap class 0 -> 1) ===
    print("\n=== Copying dataset2_split train into train (class 0 -> 1) ===")
    n = copy_with_labels(
    ...
    print("\n=== Copying dataset2_split valid into valid (class 0 -> 1) ===")
    n = copy_with_labels(
    ...
    print("\n=== Copying dataset2_split test into test (class 0 -> 1) ===")
    n = copy_with_labels(
