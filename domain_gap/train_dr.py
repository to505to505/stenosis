"""Train a clean ResNet-50 (no MixStyle, no GRL/DANN) on Dataset A using
Extreme Domain Randomization (Albumentations) for domain-generalisation.

Output: ``checkpoints/resnet50_arcade_dr_best.pth`` (binary stenosis-
presence classifier, 2048-D penultimate later used for embeddings).
"""
...
def main():
    ...
    best_acc = -1.0
    best_path = OUT_DIR / 'resnet50_arcade_dr_best.pth'
    last_path = OUT_DIR / 'resnet50_arcade_dr_last.pth'
